...
import 'package:yakpharm/screens/drug_detail_chemist.dart'; // DrugDetailPage import
...
class _SearchPageState extends State<CSearchPage> {
    ...
    return ListTile(
      ...
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const CDrugDetailPage(),
          ),
        );
      },
    );
